...
all:
prefix=/home/aran/my_lightnvm/Workspace/qemu-ufs-0.1
bindir=${prefix}/bin
libdir=${prefix}/lib
...
libs_softmmu=-lpixman-1 -lutil -lncurses -ltinfo   -lfdt
ARCH=x86_64
CONFIG_DEBUG_TCG=y
CONFIG_POSIX=y
CONFIG_LINUX=y
...
VERSION=2.1.50
PKGVERSION=
SRC_PATH=/home/aran/my_lightnvm/Workspace/qemu-ufs
...
QEMU_INCLUDES=-I$(SRC_PATH)/tcg -I$(SRC_PATH)/tcg/i386 -I$(SRC_PATH)/linux-headers -I/home/aran/my_lightnvm/Workspace/qemu-ufs/linux-headers -I. -I$(SRC_PATH) -I$(SRC_PATH)/include
AUTOCONF_HOST := 
